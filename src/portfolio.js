...
const greeting = {
  ...
  line: "",
  nickname: "",
  full_name: "Harishankar P V",
  subTitle:
    "Finial year CSE Undergrad. Full Stack Developer, Deep Learning & Quantum Computing Enthusiast. Always Learning!",
  resumeLink: " ",
  mail: "harishankarpv9@gmail.com",
};

const socialMediaLinks = {
  /* Your Social Media Link */
  github: "https://github.com/harryNeo9",
  linkedin: "https://www.linkedin.com/in/harishankarpv/",
  gmail: "harishankarpv9@gmail.com",
  gitlab: " ",
  facebook: " ",
  twitter: "https://twitter.com/HarryNeo9",
  instagram: " ",
};
...
const skills = {
  data: [
    ...
    {
      title: "Web3 DApps & Blockchain ",
      fileName: "BlockchainImg",
      skills: [
        // "⚡ Experience of working with Computer Vision and NLP projects",
        "⚡ This section will be updated soon. ",
        "⚡ Links to sites and ratings will be put here!",
        // "⚡ Experience with 10+ Projects",
      ],
      softwareSkills: [
        {
        ...
        },
        {
          ...
          fontAwesomeClassname: "fa-brands:hackerrank",
          style: {
            backgroundColor: "transparent",
            color: "#00EA64",
          },
...
const degrees = {
  degrees: [
    {
      title: "SRM Institute of Science and Technology - Chennai",
      subtitle:
        "B.Tech. in Computer Science Engineering with Specilaization in Big Data Analaytics",
      logo_path: "sal.png",
      alt_name: "SETI",
      duration: "2019 - Present",
      descriptions: [
        "⚡ I have studied core subjects like Data Structures, Algorithms,  Opearting System, Networking etc.",
  ...
  data: [
    {
      id: "0",
      name: "Travel Log App",
      url: "https://github.com/shvam0000/travel-log-app",
      description:
        "MERN Stack, CRUD, JWT Authentication, Add, Update, Delete Places Visited, Add Photos, Make Album",
      languages: [
        {
          name: "ReactJS",
